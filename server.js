...
.main-btn:nth-child(1){background:#2c6fbd}
.main-btn:nth-child(2){background:#2c6fbd}
.main-btn:nth-child(3){background:#2c6fbd}
.main-btn:nth-child(4){background:#2c6fbd}
.main-btn:nth-child(5){background:#2c6fbd}
...
.btn-primary{background:#2c6fbd}.btn-success{background:#2c6fbd}.btn-warning{background:#2c6fbd}.btn-info{background:#2c6fbd}.btn-back{background:#6b9fd4}.btn-export{background:#2c6fbd}.btn-danger{background:#c0392b}.btn-pdf{background:#2c6fbd}.btn-print{background:#2c6fbd}.btn-edit{background:#2c6fbd;color:#fff}.btn-notify{background:#2c6fbd;color:#fff}.btn-excel{background:#2c6fbd;color:#fff}
...
<button class="filter-btn filter-btn-search" id="btnFR">Tìm</button><button class="filter-btn filter-btn-reset" id="btnRR">↻</button>
...
<div class="form-group"><label>Lý do tuyển dụng <span class="required-star">*</span></label>
<select id="rf_reason_select" required onchange="toggleRFReasonOther(this)">
<option value="">-- Chọn lý do --</option>
<option value="Thay thế nhân sự nghỉ việc">Thay thế nhân sự nghỉ việc</option>
<option value="Thay thế nhân sự nghỉ thai sản / nghỉ dài hạn">Thay thế nhân sự nghỉ thai sản / nghỉ dài hạn</option>
<option value="Mở rộng sản xuất / tăng sản lượng">Mở rộng sản xuất / tăng sản lượng</option>
<option value="Thành lập bộ phận / vị trí mới">Thành lập bộ phận / vị trí mới</option>
<option value="Tái cấu trúc tổ chức">Tái cấu trúc tổ chức</option>
<option value="Tuyển theo dự án / thời vụ">Tuyển theo dự án / thời vụ</option>
<option value="Yêu cầu chiến lược / công nghệ mới">Yêu cầu chiến lược / công nghệ mới</option>
<option value="Khác">Khác (ghi rõ)</option>
</select></div>
<div class="form-group" id="rfReasonOtherGroup" style="display:none"><label>Ghi rõ lý do khác <span class="required-star">*</span></label><input type="text" id="rf_reasonOther" placeholder="Nhập lý do cụ thể..."></div>
<div class="form-group"><label>Ngày cần nhân sự <span class="required-star">*</span></label><input type="date" id="rf_startDate" required></div>

<div class="section-title">II. Thông tin chi tiết</div>
<div class="form-group"><label>Địa điểm làm việc <span class="required-star">*</span></label>
...
<div class="form-group"><label>Thời gian làm việc <span class="required-star">*</span></label>
...
<div class="form-group"><label>Môi trường làm việc</label><textarea id="rf_environment" rows="3" placeholder="Mô tả môi trường làm việc..."></textarea></div>
<div class="form-group"><label>Mô tả công việc <span class="required-star">*</span></label><textarea id="rf_jd" rows="4" placeholder="Mô tả chi tiết công việc..." required></textarea></div>
<div class="form-group"><label>Yêu cầu <span class="required-star">*</span></label><textarea id="rf_requirements" rows="4" placeholder="Các yêu cầu đối với ứng viên..." required></textarea></div>
<div class="form-group"><label>Chế độ phúc lợi</label><textarea id="rf_benefits" rows="4" placeholder="Mô tả chế độ phúc lợi..."></textarea></div>
...
<div class="container"><div class="card">
<div class="actions-bar"><h2>Chi Tiết</h2><div><button class="btn btn-back" id="btnBackRD">←</button><button class="btn btn-edit" id="btnEditR">Sửa</button><button class="btn btn-pdf" id="btnPDFRD">PDF</button><button class="btn btn-print" id="btnPrintRD">In</button></div></div>
...
<div class="container"><div class="card">
<div class="actions-bar"><h2>Danh Sách Ứng Viên</h2><div><button class="btn btn-back" id="btnBackCL">←</button><button class="btn btn-primary" id="btnNewCand">+ Thêm</button><button class="btn btn-pdf" id="btnPDFCL">PDF</button><button class="btn btn-excel" id="btnExcelCL">Excel</button></div></div>
<div class="search-filter-bar"><h3>Tìm kiếm</h3>
<div class="filter-row">
...
<button class="filter-btn filter-btn-search" id="btnFC">Tìm</button><button class="filter-btn filter-btn-reset" id="btnRC">↻</button>
...
<div class="form-group"><label>Vị trí 1 <span class="required-star">*</span></label><select id="cf_wish1" required></select><div class="error-msg" id="err_cf_wish1">Bắt buộc</div></div>
...
<div class="container"><div class="card">
<div class="actions-bar"><h2>Chi Tiết Ứng Viên</h2><div><button class="btn btn-back" id="btnBackCD">←</button><button class="btn btn-edit" id="btnEditC">Sửa</button><button class="btn btn-pdf" id="btnPDFCD">In Phiếu ShinEtsu</button></div></div>
...
<div class="container"><div class="card">
<div class="actions-bar"><h2>Lịch Phỏng Vấn</h2><div><button class="btn btn-back" id="btnBackIVL">←</button><button class="btn btn-pdf" id="btnPDFIVL">PDF</button><button class="btn btn-excel" id="btnExcelIVL">Excel</button></div></div>
...
<button class="filter-btn filter-btn-search" id="btnFI">Tìm</button><button class="filter-btn filter-btn-reset" id="btnRI">↻</button>
...
<div class="container"><div class="card">
<div class="actions-bar"><h2>Kết Quả PV</h2><div><button class="btn btn-back" id="btnBackRes">←</button><button class="btn btn-pdf" id="btnPDFRes">PDF</button><button class="btn btn-excel" id="btnExcelRes">Excel</button></div></div>
<div class="search-filter-bar"><h3>Tìm</h3><div class="filter-row">
...
<button class="filter-btn filter-btn-search" id="btnFRes">Tìm</button><button class="filter-btn filter-btn-reset" id="btnRRes">↻</button>
</div></div>
...
<div class="container"><div class="card">
<div class="actions-bar"><h2>Nhân Viên Mới</h2><div><button class="btn btn-back" id="btnBackOB">←</button><button class="btn btn-pdf" id="btnPDFOB">PDF</button><button class="btn btn-excel" id="btnExcelOB">Excel</button></div></div>
<div class="search-filter-bar"><h3>Tìm</h3><div class="filter-row">
...
<button class="filter-btn filter-btn-search" id="btnFO">Tìm</button><button class="filter-btn filter-btn-reset" id="btnRO">↻</button>
...
<script>
function toggleRFReasonOther(sel){var g=document.getElementById('rfReasonOtherGroup');if(sel.value==='Khác'){g.style.display='block';document.getElementById('rf_reasonOther').required=true;}else{g.style.display='none';document.getElementById('rf_reasonOther').required=false;document.getElementById('rf_reasonOther').value='';}}var RC=1,IC=1,D={r:[],c:[],iv:[],ivr:[],ia:[],ob:[],notify:[],logs:[]};
